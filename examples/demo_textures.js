function getConfig()
{
    ...
    var tin0 = new cuardo.WfsTinLayer( urlTin, urlImageBase0, translation, 32, terrain, [0, MT] );

    // subsampled version
    var urlImageBase1 = "http://" + domain + "/w/textures/LYON_3_Appearance_sub/";
    var tin1 = new cuardo.WfsTinLayer( urlTin, urlImageBase1, translation, 32, terrain, [MT, MT<<1] );
