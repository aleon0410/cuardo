function getConfig()
{
    ...
    var tin0 = new cuardo.WfsTinLayer( urlTin, urlImageBase0, cuardo.cuardo.translation, 32, terrain, [0, MT] );

    // subsampled version
    var urlImageBase1 = "http://" + domain + "/w/textures/LYON_3_Appearance_sub/";
    var tin1 = new cuardo.WfsTinLayer( urlTin, urlImageBase1, cuardo.cuardo.translation, 32, terrain, [MT, MT<<1] );
